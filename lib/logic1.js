  ...
  async function createitem(tx){
    ...
    .then(function(producerparticipantregistry){
        if (typeof producer.items == 'undefined')
        {
            ...
            producer.items[0]= item;
            producer.availibility[0] = "Available";
        }
        else{
            producer.items.push(item);
 ...
 */
  ...
  */
  ...
  async function productcreation(tx){ 
    ...
    ,then(function(){
        console.log("Product assest created");
        return getParticipantRegistry('org.supplychain1.Processor')
    })
    .then(function(processorparticipantregistry){
        ...
        if(typeof processor.products == 'undefined'){
            ...
            processor.products[0] = product;
            processor.availibility[0] = "Available";
        }
        else{
            processor.products.push(product);
       ...
       if(flag==0){
            ...
            .then(function(processorparticipantregistry){
                if(typeof receivingprocessor.products == 'undefined'){
                    ...
                    receivingprocessor.products[0] = productsreceived[0];
                    receivingprocessor.availibility[0] = "Available";
                    
                    for(var i=1;i<productsreceived.length;i++)
                    {
                        receivingprocessor.products.push(productsreceived[i]);
 ...
 */
  ...
  * @param {org.supplychain1.createshipmentfromwarehousetoretailer} tx
  * @transaction
  */
 ...
 async function shipmentfromwarehousetoretailer(tx){  
    ...
    return getParticipantRegistry('org.supplychain1.Retailer')
  ...
  * @param {org.supplychain1.delveryconfirmedbywarehouseshipper} tx
  * @transaction
  */
 ...
 * @param {org.supplychain1.qualityinspection} tx
 * @transaction
 */
 ...
 async function qualitycheck(tx) {
     ...
     var lastprocessortype,firstwarehousetype;
     ...
     .then(function(productassetregistry){
        ...
        {
            throw new Error("Quality inspection cannot be done now as the products have not been made completely.")
        }
  ...
  * @param {org.supplychain1.traceproduct} tx
  * @transaction
  */
