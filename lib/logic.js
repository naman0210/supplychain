 ...
 */
 ...
 async function initiate(tx) {
     ...
     .then(function(assetregistry1){
        ...
        config.type=tx.type;
        return assetregistry1.add(config);
     })
     .then(function(){
         return 'Initiated';
     })
  ...
  */
  ...
  async function createitem(tx){
    ...
    .then(function(assetregistry){
        ...
        if(tx.producer.getFullyQualifiedIdentifier() !== currentParticipant.getFullyQualifiedIdentifier() && currentParticipant.getFullyQualifiedIdentifier() != "org.hyperledger.composer.system.NetworkAdmin#admin")
        {
    ...
    .then(function(producerparticipantregistry){
        ...
        return producerparticipantregistry.update(producer);
    })
    .then(function(){
        return 'Item created';
    })
 ...
 */
 ...
 async function createshipper(tx){
    ...
    .then(function(producerparticipantregistry){
        ...
        return producerparticipantregistry.update(prod);
    })
    .then(function(){
...
async function shipmentfromproducertoprocessor(tx){
    ...
    .then(function(exists){
        ...
        if(tx.shipperfromproducertoprocessor.getFullyQualifiedIdentifier() !== currentParticipant.getFullyQualifiedIdentifier() && currentParticipant.getFullyQualifiedIdentifier() != "org.hyperledger.composer.system.NetworkAdmin#admin")
        {
            throw new Error("Not authorised!!");
        }
        if(!exists)
    ...
    .then(function(itemassetregistry){
        ...
        return itemassetregistry.updateAll(items);
    })
    .then(function(){
 ...
 */
 ...
 async function delveryconfirmed(tx){
    ...
    .then(function(shipmentregistry){
        if(shipper.getFullyQualifiedIdentifier() !== currentParticipant.getFullyQualifiedIdentifier() && currentParticipant.getFullyQualifiedIdentifier() != "org.hyperledger.composer.system.NetworkAdmin#admin")
        {
    ...
    .then(function(processorregistry){
        ...
        return processorregistry.update(processor);
    })
    .then(function(){
  ...
  */
  ...
  async function productcreation(tx){ 
    ...
    .then(function(productregistry){
        if(currentParticipant.getFullyQualifiedIdentifier() !== processor.getFullyQualifiedIdentifier() && currentParticipant.getFullyQualifiedIdentifier() != "org.hyperledger.composer.system.NetworkAdmin#admin")
        {
   ...
   */
   ...
   async function shipperfromprocessor(tx){
    ...
    shipper.email=tx.email;
    shipper.location=tx.location;
    if(tx.processor.getFullyQualifiedIdentifier() !== currentParticipant.getFullyQualifiedIdentifier() && currentParticipant.getFullyQualifiedIdentifier() != "org.hyperledger.composer.system.NetworkAdmin#admin")
    {
        throw new Error("Not authorised!!");
    }
    ...
    .then(function(processorparticipantregistry){
        ...
        return processorparticipantregistry.update(proc);
    })
    .then(function(){
        return ('SHipper created');
    })
  ...
  */
  ...
  async function shipmentfromprocessortowarehouse(tx){  
    ...
    .then(function(productassetregistry){
        ...
        return productassetregistry.updateAll(shippingproducts);
    })
    .then(function(){
        return 'Shipment created';
    })
   ...
   */
   ...
   async function deliveryconfirmedbyprocessorshipper(tx){
       ...
       if(flag==0){
            ...
            .then(function(processorparticipantregistry){
                ...
                return processorparticipantregistry.update(receivingprocessor);
            })
            .then(function(){
                return 'Delivery confirmed';
            })
    ...
    */
    ...
    async function createshipperforwarehouse(tx) {
        ...
        if(tx.warehouse.getFullyQualifiedIdentifier() !== currentParticipant.getFullyQualifiedIdentifier() && currentParticipant.getFullyQualifiedIdentifier() != "org.hyperledger.composer.system.NetworkAdmin#admin")
        {
            throw new Error("Not authorised!!!");
        }
 ...
 */
 ...
 async function shipmentfromwarehousetowarehouse(tx){  
    ...
    .then(function(productassetregistry){
        ...
        return productassetregistry.updateAll(products);
    })
    .then(function(){
        return 'Shipment created';
    })
    ...
    if(flag==0){
         ...
         .then(function(warehouseparticipantregistry){
           if(typeof receivingwarehouse.products == 'undefined')
            ...
            return warehouseparticipantregistry.update(receivingwarehouse)            
         })
         .then(function(){
             return 'Delivery confirmed';
         })
 ...
 */
 ...
 async function readyforinspection(tx){ //permission yet to be made
    ...
    var flag=0;
     ...
     .then(function(){
         return 'Product ready for inspection';
     })
     .catch(function(error){
         return (error);
     });
 ...
 */
 ...
 async function qualitycheck(tx) {
    ...
    let currentParticipant = getCurrentParticipant();
    if(currentParticipant.getFullyQualifiedIdentifier() !== 'org.supplychain.QI#7734' && currentParticipant.getFullyQualifiedIdentifier() != "org.hyperledger.composer.system.NetworkAdmin#admin"){
        throw new Error("Not authorised!!");
    }
  ...
  */
  ...
  async function traceproduct(tx){
    ...
    result.push(producers.name);
    result.push(shipperfromproducers.name);
    result.push(processors.name);
    result.push(shippersfromprocessor.name);
    result.push(warehouses.name);
    result.push(shippersfromwarehouse.name);
    result.push(retailer.name);
 ...
 * @returns {org.supplychain.Shipper_from_producer_to_processor[]} shipper
 * @transaction
 */
 ...
 * @returns {org.supplychain.Shipper_from_processor[]} shipper
 * @transaction
 */
 ...
 * @returns {org.supplychain.Shipper_from_warehouse[]} shipper
 * @transaction
 */
 ...
 * @returns {org.supplychain.Item} items
 * @transaction
 */
 ...
 * @returns {org.supplychain.Product} products
 * @transaction
 */
 ...
 * @returns {org.supplychain.Shipment_from_producer_to_processor} shipments
 * @transaction
 */
 ...
 * @returns {org.supplychain.Shipment_from_processor} shipments
 * @transaction
 */
 ...
 * @returns {org.supplychain.Shipment_from_warehouse} shipments
 * @transaction
 */
